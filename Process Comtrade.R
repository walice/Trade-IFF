...
yr1999 <- read.table("type-C_r-ALL_ps-1999_freq-A_px-HS_pub-20051228_fmt-csv_ex-20151115.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
nrow1999 <- nrow(yr1999)
yr1999 <- yr1999 %>% filter(Aggregate.Level == 2)

yr2000 <- read.table("type-C_r-ALL_ps-2000_freq-A_px-HS_pub-20180115_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2001 <- read.table("type-C_r-ALL_ps-2001_freq-A_px-HS_pub-20180115_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2002 <- read.table("type-C_r-ALL_ps-2002_freq-A_px-HS_pub-20180115_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2003 <- read.table("type-C_r-ALL_ps-2003_freq-A_px-HS_pub-20180113_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2004 <- read.table("type-C_r-ALL_ps-2004_freq-A_px-HS_pub-20180112_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2005 <- read.table("type-C_r-ALL_ps-2005_freq-A_px-HS_pub-20180109_fmt-csv_ex-20180225.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2006 <- read.table("type-C_r-ALL_ps-2006_freq-A_px-HS_pub-20171212_fmt-csv_ex-20171229.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2007 <- read.table("type-C_r-ALL_ps-2007_freq-A_px-HS_pub-20171212_fmt-csv_ex-20171229.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2008 <- read.table("type-C_r-ALL_ps-2008_freq-A_px-HS_pub-20180726_fmt-csv_ex-20180828.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2009 <- read.table("type-C_r-ALL_ps-2009_freq-A_px-HS_pub-20180726_fmt-csv_ex-20180828.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2010 <- read.table("type-C_r-ALL_ps-2010_freq-A_px-HS_pub-20181226_fmt-csv_ex-20190116.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2011 <- read.table("type-C_r-ALL_ps-2011_freq-A_px-HS_pub-20181115_fmt-csv_ex-20181127.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2012 <- read.table("type-C_r-ALL_ps-2012_freq-A_px-HS_pub-20181220_fmt-csv_ex-20181221.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2013 <- read.table("type-C_r-ALL_ps-2013_freq-A_px-HS_pub-20181231_fmt-csv_ex-20190116.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2014 <- read.table("type-C_r-ALL_ps-2014_freq-A_px-HS_pub-20181226_fmt-csv_ex-20190117.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2015 <- read.table("type-C_r-ALL_ps-2015_freq-A_px-HS_pub-20181116_fmt-csv_ex-20181127.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2016 <- read.table("type-C_r-ALL_ps-2016_freq-A_px-HS_pub-20190109_fmt-csv_ex-20190116.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
...
yr2017 <- read.table("type-C_r-ALL_ps-2017_freq-A_px-HS_pub-20181220_fmt-csv_ex-20181221.csv",
                     sep = ",", header = TRUE, quote = "\"", fill = TRUE,
                     colClasses = c("NULL", NA, "NULL", "NULL", NA, "NULL", "NULL", NA, "NULL", NA, NA,
                                    "NULL", NA, NA, NA, NA, "NULL", "NULL", "NULL", "NULL", NA, "NULL"))
